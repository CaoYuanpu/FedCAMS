...
from utils import get_model, get_dataset, average_weights, average_weights_lora_reset_agg, exp_details, average_parameter_delta
...
#     out_dir_name = args.model + args.dataset + args.optimizer + '_lr' + str(args.lr) + '_locallr' + str(args.local_lr) + '_localep' + str(args.local_ep) +'_localbs' + str(args.local_bs) + '_eps' + str(args.eps)
    file_name = '/{}_{}_{}_llr[{}]_glr[{}]_eps[{}]_le[{}]_bs[{}]_iid[{}]_mi[{}]_frac[{}]_resetagg{}.pkl'.\
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if (epoch+1) % args.reset == 0:
            print("Reset agg")
            bn_weights = average_weights_lora_reset_agg(local_weights)
